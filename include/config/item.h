...
#define I_EXP_SHARE_FLAG        0x25        // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    0x404E  // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        0x26                  // If this flag is assigned, the Vs Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working. Documentation for the Vs. Seeker can be found in docs/tutorials/vs_seeker.md.
...
#define I_ORAS_DOWSING_FLAG         0x27        // Replace 0 with an unused flag to enable the Dowsing Machine mechanic from ORAS.
