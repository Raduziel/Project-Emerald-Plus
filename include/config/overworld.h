...
#define OW_SHOW_ITEM_DESCRIPTIONS       1   // If enabled, item descriptions/images will be shown when finding items.
...
#define OW_FLAG_NO_ENCOUNTER        0x23  // If this flag is set, wild encounters will be disabled.
...
#define OW_FLAG_POKE_RIDER          0x24  // If this flag is set, the player will be able to use fly from the Pokenav Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
