...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+
    { ITEM_POTION,          {  35,   _,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_TINY_MUSHROOM,   {  25,  10,   6,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_REPEL,           {   8,  30,   _,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_SUPER_POTION,    {   8,  10,  30,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_POKE_DOLL,       {   8,  10,   9,  18,   _,   _,   _,   _,   _,   _, } },
    { ITEM_BIG_MUSHROOM,    {   3,  10,   9,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_SUPER_REPEL,     {   3,  10,   9,   9,  18,   _,   _,   _,   _,   _, } },
    { ITEM_FULL_HEAL,       {   3,   3,   9,   8,   9,  14,   _,   _,   _,   _, } },
    { ITEM_REVIVE,          {   3,   3,   3,   8,   8,   9,  14,   _,   _,   _, } },
    { ITEM_HYPER_POTION,    {   3,   3,   3,   4,   8,   9,   8,  14,   _,   _, } },
    { ITEM_ETHER,           {   1,   1,   3,   4,   4,   _,   _,   _,   _,   _, } },
    { ITEM_MAX_REPEL,       {   _,   3,   3,   4,   4,   9,   8,   8,  14,   _, } },
    ...
    { ITEM_MAX_POTION,      {   _,   _,   3,   4,   4,   4,   8,   8,   9,  14, } },
    { ITEM_MAX_ETHER,       {   _,   _,   1,   1,   4,   4,   4,   _,   _,   _, } },
    { ITEM_PP_UP,           {   _,   _,   1,   1,   1,   4,   4,   5,   4,   5, } },
    { ITEM_BIG_NUGGET,      {   _,   _,   1,   1,   1,   1,   4,   5,   4,   5, } },
    { ITEM_SERIOUS_MINT,    {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_BRAVE_MINT,      {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_RELAXED_MINT,    {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_QUIET_MINT,      {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_SASSY_MINT,      {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_NAUGHTY_MINT,    {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_LAX_MINT,        {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_RASH_MINT,       {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_NAIVE_MINT,      {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_IMPISH_MINT,     {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_CAREFUL_MINT,    {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_LONELY_MINT,     {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_MILD_MINT,       {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_GENTLE_MINT,     {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_HASTY_MINT,      {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_BOLD_MINT,       {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_CALM_MINT,       {   _,   _,   _,   1,   1,   1,   1,   1,   1,   1, } },
    { ITEM_ADAMANT_MINT,    {   _,   _,   _,   _,   _,   1,   1,   1,   1,   1, } },
    { ITEM_JOLLY_MINT,      {   _,   _,   _,   _,   _,   1,   1,   1,   1,   1, } },
    { ITEM_MODEST_MINT,     {   _,   _,   _,   _,   _,   1,   1,   1,   1,   1, } },
    { ITEM_TIMID_MINT,      {   _,   _,   _,   _,   _,   1,   1,   1,   1,   1, } },
    { ITEM_BALM_MUSHROOM,   {   _,   _,   _,   4,   4,   2,   2,   4,   5,   5, } },
    { ITEM_MAX_REVIVE,      {   _,   _,   _,   4,   4,   4,   4,   6,   6,   7, } },
    { ITEM_SHINY_STONE,     {   _,   _,   _,   _,   _,   2,   2,   3,   4,   4, } },
    { ITEM_ELIXIR,          {   _,   _,   _,   _,   1,   1,   4,   4,   4,   5, } },
    { ITEM_MAX_ELIXIR,      {   _,   _,   _,   _,   _,   _,   1,   1,   2,   3, } },
